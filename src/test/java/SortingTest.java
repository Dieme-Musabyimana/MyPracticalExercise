...
public class SortingTest {
    ...
    void validateAllSortingOptions() {
        try (Playwright playwright = Playwright.create()) {
            ...
            Page page = browser.newPage();
            // Increased timeout for the initial navigation just in case the server is slow
            page.navigate("https://practicesoftwaretesting.com/", new Page.NavigateOptions().setTimeout(60000));

            // CHANGED: Use DOMCONTENTLOADED instead of NETWORKIDLE
            ...
            // Wait specifically for the dropdown to be visible
